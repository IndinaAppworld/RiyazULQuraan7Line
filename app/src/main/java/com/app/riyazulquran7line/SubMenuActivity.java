...
//        inistView();
        ...
        if(Constants.sp.getBoolean("autofav", false)==false)
        {
            ...
            db.  addContact_Fav(new Contact("", "Al-Mulk |  سورة الملك   |2019","Al-Mulk |  سورة الملك   |2019"));
            db.  addContact_Fav(new Contact("", "Ar-Rahman |  سورة الرحمن   |1903","Ar-Rahman |  سورة الرحمن   |1903"));
            db.  addContact_Fav(new Contact("", "Ya Seen |  يٰس   |1560","Ya Seen |  يٰس   |1560"));
            db. addContact_Fav(new Contact("", "Al-Kahf |  سورة الكهف   |1032","Al-Kahf |  سورة الكهف   |1032"));
...
//				 if(db.)
        ...
        else
        {
            ...
            {
                contacts.add(new Book(""+(i+1)+". "+Constants.paraname_english[i], (i+1)+"  . "+ Constants.paraname_arabic[i], ""+Constants.paraIndex[i]));
            }
        }
...
//                text.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 18);
    ...
    public void tabclick(int m)
    {
        ...
        line[0].setVisibility(View.GONE);
        line[1].setVisibility(View.GONE);
