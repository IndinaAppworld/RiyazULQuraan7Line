...
loadSideMenu();
    ...
    public void loadSideMenu()
    {
        ...
        if(Constants.LANGUAGE_ID==Constants.ENGLISH)
        {
            ...
            options.add("Muqaddma");
            options.add(Constants.FAZILT_TEXT);
            options.add(Constants.MUTTARIFAQ);
...
CipherNormal menu_titles[]=new CipherNormal[6];
    ...
    int counter=0;
    RelativeLayout menuRel[]=new RelativeLayout[6];
    public void inistView()
    {
        iv_icon = (ImageView) findViewById(R.id.iv_icon);
        menuRel[0]=(RelativeLayout)findViewById(R.id.menu1);
        menuRel[1]=(RelativeLayout)findViewById(R.id.menu2);
        menuRel[2]=(RelativeLayout)findViewById(R.id.menu3);
        menuRel[3]=(RelativeLayout)findViewById(R.id.menu4);
        menuRel[4]=(RelativeLayout)findViewById(R.id.menu5);
        menuRel[5]=(RelativeLayout)findViewById(R.id.menu6);
        for(int i=0;i<6;i++)
            menuRel[i].setOnClickListener(new MyListener(i));
...
//            icons_image[counter]=(ImageView)view[i].findViewById(R.id.icon2);
//            icons_image[counter].setImageResource(icons[counter]);
//            menu_titles[counter]=(CipherNormal)view[i].findViewById(R.id.title2);
//            menu_titles[counter].setText(titles[counter]);
//            menu_linear[counter].setOnClickListener(new MyListener(counter));
